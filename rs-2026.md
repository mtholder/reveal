### How should we build a tree of about 3.7 million tips?
...
### Open Tree Taxonomy stats
  * currently at version 3.0 [info+download link](https://tree.opentreeoflife.org/about/taxonomy-version/ott3.7.3)
  * 3.7 million taxonomic names thought to be valid
...
as in the case of [this grouping of birds](https://tree.opentreeoflife.org/opentree/argus/opentree16.1@mrcaott246ott5021)
...
### Recent work
  1. "custom" supertree 
  2. beta version of an API with dates ( https://github.com/OpenTreeOfLife/ChronoSynth )

See https://opentreeoflife.github.io/SSBworkshop2026/



### Future plans:
  1. more work on targeted groups
  2. integration into GBIF
  3. improving paleo coverage




### Targeting groups:
Worked with CLO and Elliot Miller:
  1. https://www.pnas.org/doi/10.1073/pnas.2409658122
  2. https://birdsoftheworld.org/bow/phylogeny
  3. https://github.com/OpenTreeOfLife/collections-1/blob/master/collections-by-owner/snacktavish/aves.json



### GBIF integration:
  1. Provide phylogeny-aware searching
  2. Visualization similar to hosted portals such as https://www.legumedata.org/phylogeny/explore/
  3. Open Tree needs to move to CoL eXtended Release https://www.catalogueoflife.org/building/releases
